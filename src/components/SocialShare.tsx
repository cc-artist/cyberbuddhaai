  ...
  const shareToPlatform = (platform: string) => {
    ...
    switch (platform) {
      ...
      case 'instagram':
        ...
        break;
      case 'whatsapp':
        shareUrl = `https://wa.me/?text=${encodeURIComponent(`${title} - ${description} ${pageUrl}`)}`;
        break;
      case 'weixin':
    ...
    <div>
      ...
      <div className="flex gap-3 mt-4">
        ...
        <button 
          ...
          className="p-2 rounded-full bg-[#25D366] text-white hover:bg-[#25D366]/90 transition-colors duration-300 flex items-center justify-center"
      ...
      {/* 评论分享模态框 */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[999999999]">
