...
export const temples: Temple[] = [
  ...
  },
  {
    ...
    image: "/temple-images/黑神话悟空山西古建筑群.jpg",
    features: [
    ...
    route: {
      ...
      itinerary: "Day 1: Arrive in Taiyuan, check in at Yunjincheng Mansion (Qing Dynasty ticket office transformed, national cultural heritage site), welcome dinner with Shanxi merchant culture experience\n\nDay 2: Exclusive tour of Xiaoxitian with Shanxi Ancient Architecture Research Institute scholar, visit mural restoration site\n\nDay 3: Visit Guangsheng Temple Feihong Pagoda, touch Ming Dynasty glaze with colored glaze fragment specimen\n\nDay 4: Private class at Shuanglin Temple Thousand-Buddha Hall, cultural relic restorer explains the dynamic aesthetic code of Weituo statue\n\nDay 5: Visit Zhenguo Temple, experiencing Five Dynasties wooden architecture\n\nDay 6: Intangible cultural heritage workshop at Tiefo Temple, complete Wukong-themed painted sculpture under guidance of ancient architecture painting inheritor\n\nDay 7: One night at Lingyan Temple Zen Meditation Courtyard, experiencing 'Wukong cultivation' atmosphere with morning bells and evening drums\n\nDay 8: Free time or optional activities, departure.",
